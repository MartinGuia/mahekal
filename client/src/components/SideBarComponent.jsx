...
function SideBarComponent() {
  ...
  text-4xl hover:bg-water-blue-hover duration-300"
        ...
        <div
          className={`${
            open ? "w-48" : "max-w-0"
          } bg-white h-screen shadow-xl relative`}
        >
          ...
          <div className="flex items-center flex-col mt-6">
            <img
              src="LogoMahekal.png"
              alt="LogoMahekal"
              className="max-[431px]:size-28 size-36"
            />
          </div>

          <div className="flex mt-10 justify-end mr-6 items-center">
            <button
              className={`hover:bg-water-blue rounded-md py-2 text-mahekal-brown px-4 flex gap-x-2 text-lg ${
                !open && "invisible"
              }`}
            >
